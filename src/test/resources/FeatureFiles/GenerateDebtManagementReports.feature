Feature: [SUC:08-07]-Generate debt management reports
  ...
  Scenario: UAT_M8-08-07-01-Verify the process of print Report-Aged Arreas Analysis report
    ...
    Then Verify file "Aged Arrears Analysis Report.pdf" has been downloaded in downloads directory "C:\\Users\\maxma\\Downloads"
  ...
  Scenario: UAT_M8-08-07-02-Verify the process of print Debt-recovery report
    ...
    Then Click run report "frmReportDetails:RunReport"
    Then Verify file "Debt Recovery Report.pdf" has been downloaded in downloads directory "C:\\Users\\maxma\\Downloads"
    Then Select report file type "EXCEL"
    Then Click run report "frmReportDetails:RunReport"
  ...
  Scenario: UAT_M8-08-07-03-Verify the process of installment agreement summary report
    ...
    Then Select return type
    Then Click run report "frmReportDetails:RunReport"
    Then Verify file "Instalment Agreement Summary Report.pdf" has been downloaded in downloads directory "C:\\Users\\maxma\\Downloads"
    Then Select report file type "EXCEL"
    Then Click run report "frmReportDetails:RunReport"
  ...
  Scenario: UAT_M8-08-07-04-Verify the process of taxpayer debt report
    ...
    Then Select return type
    Then Click run report "frmReportDetails:RunReport"
    Then Verify file "Taxpayer Debt Report.pdf" has been downloaded in downloads directory "C:\\Users\\maxma\\Downloads"
    Then Select report file type "EXCEL"
    Then Click run report "frmReportDetails:RunReport"
  ...
  Scenario: UAT_M8-08-07-05-Verify the process of write off report
    ...
    Then Click run report "frmReportDetails:RunReport"
    Then Verify file "Write Off Report.pdf" has been downloaded in downloads directory "C:\\Users\\maxma\\Downloads"
    Then Select report file type "EXCEL"
    Then Click run report "frmReportDetails:RunReport"
